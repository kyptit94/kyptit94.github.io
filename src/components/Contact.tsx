...
export default function Contact() {
  ...
  return (
    <section id="contact" className="w-full bg-gray-50 dark:bg-gray-800">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:kevin.phamky@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                      kevin.phamky@gmail.com
                    </a>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+84342027194" className="text-blue-600 dark:text-blue-400 hover:underline">
                      +84342027194
                    </a>
                  </div>
                </div>
